...
void printHardwareCounters(){
    ...
    print('\n');
    /*print("\nNo. of clock cycles elapsed: ");*/ print_dec(mcycle); print(',');
    /*print("\nNo. of instructions retired: ");*/ print_dec(minstret); print(',');
    /*print("\nNo. of memory instructions retired: "); */print_dec(mhpmcounter3); print(',');
    /*print("\nNo. of I-cache misses from instruction-fetch: "); */print_dec(mhpmcounter4); print(',');
    /*print("\nNo. of D-cache misses from memory operations: "); */print_dec(mhpmcounter5); print(',');
    /*print("\nNo. of CPU stalls due to I-cache misses: "); */print_dec(mhpmcounter6); print(',');
    /*print("\nNo. of CPU stalls due to D-cache misses: "); */print_dec(mhpmcounter7); print(',');
    /*print("\nNo. of CPU stalls due to non-forwarded data hazards: "); */print_dec(mhpmcounter8); print(',');
